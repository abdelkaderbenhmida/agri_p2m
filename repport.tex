...
\begin{center}
  ...
  % ── Haut : logos + texte institutionnel ───────────────
  \vspace*{0.5cm}
  \begin{minipage}[c]{0.22\linewidth}
    \centering
    \includegraphics[width=2.8cm]{supcom.png}
  \end{minipage}
  \hfill
  \begin{minipage}[c]{0.50\linewidth}
    ...
    Université de Carthage\\[2pt]
    École Supérieure des Communications de Tunis}
  \end{minipage}
  \hfill
  \begin{minipage}[c]{0.22\linewidth}
    \centering
    \includegraphics[width=2.8cm]{carthage.png}
  \end{minipage}

  \vspace*{2.8cm}

  % ── Type de rapport ───────────────────────────────────
  {\normalsize\scshape Rapport de Projet Préparation Métier (P2M)}
...
\vspace*{1cm}
\color{supblue}\rule{\linewidth}{1.5pt}
\begin{center}
  {\LARGE\bfseries\color{supblue} Remerciements}
\end{center}
\color{supblue}\rule{\linewidth}{1.5pt}
...
\color{black}
Nous tenons tout d'abord à remercier \textbf{l'École Supérieure des 
Communications de Tunis (Sup'Com)} de nous avoir offert l'opportunité 
de réaliser ce projet dans le cadre du module Projet Préparation Métier, 
une expérience qui nous a permis d'enrichir nos connaissances et de 
développer nos compétences professionnelles.

\vspace*{2cm}

Nous adressons également nos sincères remerciements à \textbf{Monsieur Harouni Zied }, notre encadrante, pour son accompagnement, ses orientations 
et ses précieux conseils qui ont guidé notre travail tout au long de 
ce projet.

\vfill

\begin{center}
  \color{supblue}\rule{0.4\linewidth}{0.6pt}
\end{center}
