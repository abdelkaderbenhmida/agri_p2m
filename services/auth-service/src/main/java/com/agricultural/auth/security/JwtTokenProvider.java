package com.agricultural.auth.security;
...
public class JwtTokenProvider {
    ...
    /**
     * Generate a JWT token with full user claims (userId, role, firstName, lastName).
     * This is required by downstream services (order, payment, delivery) to identify the user.
     */
